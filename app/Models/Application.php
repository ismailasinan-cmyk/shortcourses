...
class Application extends Model
{
    ...
    protected $fillable = [
        ...
        'amount', 'payment_status', 'payment_rrr',
        'application_fee_amount', 'application_fee_status', 'course_fee_status',
        'admission_status', 'certificate_path', 'certificate_issued_at', 'locale'
    ];
